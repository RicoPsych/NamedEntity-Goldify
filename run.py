...
user_agent= 'WikipediaHitsScraper (s184546@student.pg.edu.pl)'
...
dataset_voxr_en = NifLoader.LoadDatasetLocal(r"D:\Informatyka\Magisterka\code\datasets\voxel\rVoxEL-en.ttl", kb_prefix_regex=r"^https://..\.wikipedia\.org/wiki/")

dataset_voxs_en = NifLoader.LoadDatasetLocal(r"D:\Informatyka\Magisterka\code\datasets\voxel\sVoxEL-en.ttl", kb_prefix_regex=r"^https://..\.wikipedia\.org/wiki/")
dataset_voxs_de = NifLoader.LoadDatasetLocal(r"D:\Informatyka\Magisterka\code\datasets\voxel\sVoxEL-de.ttl", kb_prefix_regex=r"^https://..\.wikipedia\.org/wiki/")
dataset_voxs_es = NifLoader.LoadDatasetLocal(r"D:\Informatyka\Magisterka\code\datasets\voxel\sVoxEL-es.ttl", kb_prefix_regex=r"^https://..\.wikipedia\.org/wiki/")
dataset_voxs_fr = NifLoader.LoadDatasetLocal(r"D:\Informatyka\Magisterka\code\datasets\voxel\sVoxEL-fr.ttl", kb_prefix_regex=r"^https://..\.wikipedia\.org/wiki/")

metrics_full_kb = [Metrics.OccurenceKB , Metrics.DispersityCtx, Metrics.DispersityAnnot, Metrics.Coherence]

pipeline_fr = GoldifyPipeline(metrics_full_kb, consistency_lang="fr", user_agent= user_agent)
pipeline_de = GoldifyPipeline(metrics_full_kb, consistency_lang="de", user_agent= user_agent)
pipeline_es = GoldifyPipeline(metrics_full_kb, consistency_lang="es", user_agent= user_agent)
pipeline_en = GoldifyPipeline(metrics_full_kb, consistency_lang="en", user_agent= user_agent)
